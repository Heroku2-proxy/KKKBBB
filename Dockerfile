...
ARG AUUID="dacfd737-847a-4285-8589-ab77d5d211b8"
...
RUN apk update && \
    ...
    cat /tmp/Caddyfile | sed -e "s/\$AUUID/$AUUID/g" -e "s/\$MYUUID-HASH/$(caddy hash-password --plaintext $AUUID)/g" >/etc/caddy/Caddyfile && \
